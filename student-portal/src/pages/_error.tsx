...
function Error({ statusCode }: ErrorProps) {
	...
	return (
		<>
			<Head>
				<title>{error.title} - Portal Ujian</title>
			...
			<div className="min-h-screen flex items-center justify-center px-4 py-12 bg-gradient-to-br from-gray-100 to-gray-200">
				<div
					className={`w-full max-w-md ${colors.bg} border ${colors.border} rounded-lg shadow-2xl p-8 animate-in fade-in duration-300`}
				>
					{/* Icon */}
