	...
	const initTake = async () => {
		try {
			...
			if (full.status === "in_progress") {
				...
				const firstUnanswered = questionList.findIndex(
					(q: any) => !ansMap[q.id]
				);
							...
							<div className="px-3 py-2">
								...
								<div className="flex items-center justify-between mb-2">
									...
									<button
										...
										className="p-1.5 bg-white bg-opacity-20 hover:bg-opacity-30 rounded text-sm font-semibold transition"
									>
										📋
									</button>
								</div>
