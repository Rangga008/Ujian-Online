...
import { Exam, ExamStatus, ExamTargetType } from "../../exams/exam.entity";
	...
	try {
		...
		const examsData = [
			// Matematika Exams
			{
				...
				classId: savedClasses[4].id, // 12 IPA 1 (class at index 4)
				targetType: ExamTargetType.CLASS,
				totalQuestions: 10,
				totalScore: 100,
			...
			},
			{
				...
				endTime,
				status: ExamStatus.PUBLISHED,
				classId: savedClasses[2].id, // 11 IPA 1 (class at index 2)
				targetType: ExamTargetType.CLASS,
				totalQuestions: 8,
				totalScore: 100,
				randomizeQuestions: true,
			...
			// Bahasa Indonesia Exam
			{
				...
				endTime,
				status: ExamStatus.PUBLISHED,
				classId: savedClasses[6].id, // 12 IPS 1 (class at index 6)
				targetType: ExamTargetType.CLASS,
				totalQuestions: 8,
				totalScore: 100,
				randomizeQuestions: true,
			...
			// Bahasa Inggris Exams
			{
				...
				endTime,
				status: ExamStatus.PUBLISHED,
				classId: savedClasses[0].id, // 10 IPA 1 (class at index 0)
				targetType: ExamTargetType.CLASS,
				totalQuestions: 8,
				totalScore: 100,
				randomizeQuestions: true,
			...
			// Historical exam (previous semester)
			{
				...
				classId: savedClasses[4].id, // 12 IPA 1 (same class)
				targetType: ExamTargetType.CLASS,
				totalQuestions: 10,
				totalScore: 100,
				randomizeQuestions: true,
